...
if($action == 'create')
{
	$sql= "INSERT INTO `billing` VALUES ('$hasil[firstname]','$hasil[lastname]','$hasil[username]','$hasil[email]','$hasil[address]','$hasil[address2]','$hasil[ccname]','$hasil[ccnumber]','$hasil[ccexpire]','$hasil[cvv]','{$namafilebaru}')";
}
elseif ($action == 'update')
{
	$sql = "UPDATE billing SET firstname =  '$hasil[firstname]', lastName = '$hasil[lastname]',foto = '$namafilebaru' where firstname = '$hasil[firstname]'";
}
elseif($action == 'delete')
{
	$sql = "DELETE from billing where firstname = '$hasil[firstname]'";
}
elseif($action == 'read')
{
